...
CREATE TABLE exchange_accounts (
    ...
    rest_connected BOOLEAN NOT NULL DEFAULT FALSE,
    websocket_connected BOOLEAN NOT NULL DEFAULT FALSE,
    private_ws_connected BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE INDEX idx_runtime_events_created_at ON runtime_events(created_at DESC);
CREATE INDEX idx_runtime_events_command_id ON runtime_events(command_id) WHERE command_id IS NOT NULL;
CREATE INDEX idx_runtime_events_type_status ON runtime_events(event_type, status);
...
CREATE INDEX idx_runtime_events_payload_gin ON runtime_events USING GIN (payload);
